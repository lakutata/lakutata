 ...
 * @constructor
 */
export async function Paginator<Options extends PaginationSearchDTO, T>(options: Options, handler: (options: Options, limit: number, offset: number) => Promise<PaginatorHandlerResult<T>>): Promise<PaginationResultDTO<T>> {
